...
module.exports = React.createClass({
	...
	render: function(){
		return (
			<div style={this.props.style} className={'zr-base-button ' + (this.props.className || '') + (this.__disabled()?' disabled':'')} onClick={this.__click} data-zr-popup-tooltip={this.__disabled()?this.props.tooltip:''}>
